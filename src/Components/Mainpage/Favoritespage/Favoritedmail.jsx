...
const FavoritedMail = (props) => {
    ...
    const [favorite,SetFavorite] = useState(props.props[1].isFavorite)
    ...
    const toggleFavoriteHandler = e => {
        ...
        // fetch(`https://clone-b8039-default-rtdb.firebaseio.com/${state.currentAcc.currentID}/inbox/${props.props[0]}/isFavorite.json`,
        // {
        //     method:'PUT',
        //     body:JSON.stringify(!props.props[1].isFavorite)
        // })
        fetch(`https://clone-b8039-default-rtdb.firebaseio.com/${state.currentAcc.currentID}/inbox/${props.props[0]}/isFavorite.json`,{
            method:'PUT',
